...
namespace IEnumerableVsIQueryable.CoreApp.Models
{
    public partial class OrdersContext : DbContext
    {
        ...
        {
            modelBuilder.Entity<LetterLanguageView>(entity =>
            {
            ...
            modelBuilder.Entity<Letter>(entity =>
            {
                ...
                entity.HasOne(d => d.Language)
                    ...
                    .OnDelete(DeleteBehavior.Restrict)
                    .HasConstraintName("FK_Letter_Language");
            });
            ...
            modelBuilder.Entity<TableWithGuid>(entity =>
            {
        ...
        public virtual DbSet<TableWithGuid> TableWithGuid { get; set; }
